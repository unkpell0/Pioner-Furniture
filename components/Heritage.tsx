  ...
  return (
    <section className="py-16 sm:py-20 md:py-24 bg-brand-cream overflow-hidden">
      <div className="container mx-auto px-6">
        <h2 
          className={`text-3xl md:text-4xl font-bold text-center text-brand-brown-dark mb-6 transition-all duration-200 ease-out ${isMounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}
        >
          Warisan Seni Nusantara dalam Setiap Ukiran
        </h2>
        <p 
          className={`text-base md:text-lg text-center text-brand-text mb-12 max-w-3xl mx-auto leading-relaxed transition-all duration-200 ease-out ${isMounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}
        >
